...
//the interface to be displayed if the user login's
app.get(
  "/todos",
...
//validating errors in signup page
...
//storing the session of the user so as to allow user without logging in
app.post(
  "/session",
